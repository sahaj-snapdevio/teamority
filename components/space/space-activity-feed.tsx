    ...
    <div className="p-6 max-w-3xl space-y-5">
      ...
      {loading ? (
        ...
        <div className="rounded-xl border bg-elevated flex flex-col items-center gap-3 py-16 text-center">
          ...
          <p className="text-sm text-base-content/60">No activity in the last 30 days</p>
        </div>
      ) : (
        <>
          <div className="rounded-xl border bg-elevated divide-y overflow-hidden">
            {entries.map((entry) => (
              <div key={entry.id} className="flex items-start gap-3 px-4 py-3 hover:bg-base-200/20 transition-colors">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-xs text-base-content/60 mt-0.5">
                    <span className="text-base-content/60">{entry.listName} · </span>

  ...
  return (
    <AvatarContext.Provider value={{ status, setStatus }}>
      <span
        ...
        data-size={size}
        className={cn(
          "avatar group/avatar relative isolate flex size-8 shrink-0 rounded-full select-none after:absolute after:inset-0 after:rounded-full after:border after:border-border after:mix-blend-darken data-[size=lg]:size-10 data-[size=sm]:size-6 dark:after:mix-blend-lighten",
          className
        )}
        {...props}
      />
